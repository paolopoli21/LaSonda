...
@Component({
  selector: 'app-detail-dataprocess',
  templateUrl: './detail-dataprocess.component.html',
  styleUrls: ['./detail-dataprocess.component.css']
})
export class DetailDataprocessComponent implements OnInit {
  displayedColumns: string[] = [];
  NumeroColonne: number = 20;

  public classContainerTable: string = "w100PcontainerTable";
  //@ViewChild("txtNumeroColonna") txtNumeroColonna?: ElementRef
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any) { 
   // this.txtNumeroColonna?.nativeElement.getTxtValue = "4";
  ...
  ngAfterViewInit(): void {
    //this.listQueryLength = this.dataJson.length;
    //console.log("listQueryLength",this.listQueryLength);
  }

  getCreateColumn(){
    if(this.dataJson[1] == null) return;
    let firtsRow =  Object.keys(this.dataJson[1]);
    let countColumn = 0;
